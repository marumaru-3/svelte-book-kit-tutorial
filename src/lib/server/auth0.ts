...
export async function sendPasswordlessLink(email: any, state: string, redirectUri: string) {
...
export async function getToken(code: any, redirectUri: string) {
	...
	params.set('client_id', env.AUTH0_CLIENT_ID as string);
	params.set('client_secret', env.AUTH0_CLIENT_SECRET as string);
